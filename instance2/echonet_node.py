"""
Copy of echonet_node.py for instance2
"""

# NOTE: this file is a copy of the main echonet_node implementation and
# expects a nodes.json and .env to be present in the same directory.
